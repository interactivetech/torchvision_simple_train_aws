...
# /Users/mendeza/Documents/projects/vision/torchvision.models.detection.fcos.py
...
class FCOS(nn.Module):
    ...
    def forward(
        ...
        if torch.jit.is_scripting():
            ...
            return losses, detections
        return self.eager_loss_and_outputs(losses, detections)
